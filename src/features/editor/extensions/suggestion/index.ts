...
/**
 * StateEffect: A way to send "messages" to update.
 ...
 * - update(): Called on every transaction, like keystrokes, to
 *   potentially update the value.
 */
 ...
 *
 * toDOM(): Called by CodeMirror to create the actual HTML element.
 */
